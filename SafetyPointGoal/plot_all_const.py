...
import numpy as np
# List of file names
file_names = ['plotting_ac_const_final.txt', 'plotting_nac_const_final.txt', 'plotting_dqn_const_final.txt']
file_names_sdt = ['plotting_ac_const_std_final.txt', 'plotting_nac_const_std_final.txt', 'plotting_dqn_const_std_final.txt']
...
plt.axhline(y = 0.1, color = 'r',label ='alpha', linestyle = 'dashed')
plt.xlabel('No of Iterations')
plt.ylabel('Average Constrained Cost')
plt.title('SafetyPointGoal1-v0 ')
#plt.title('Comparision of average rewards for different algorithms')
plt.legend()
plt.savefig('plots/avg_constraint_reward_all.png')
plt.show()
